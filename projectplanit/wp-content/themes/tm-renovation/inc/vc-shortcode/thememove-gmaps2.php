...
vc_map( array(
	...
	'params'   => array(
		array(
			...
			'value'       => '480',
			'description' => esc_html__( 'Enter map height (in pixels or %)', 'infinity' ),
		),
		array(
			'type'        => 'textfield',
			...
			'value'       => '100%',
			'description' => esc_html__( 'Enter map width (in pixels or %)', 'infinity' ),
		),
		array(
			'type'        => 'textfield',
		...
		array(
			...
			'value'      => array(
				esc_html__( 'Enable mouse scroll wheel zoom', 'infinity' ) => 'yes',
			),
		),
		array(
			'type'        => 'dropdown',
		...
		array(
			'group'       => esc_html__( 'Markers', 'infinity' ),
			'type'        => 'param_group',
			'heading'     => esc_html__( 'Markers', 'infinity' ),
			'param_name'  => 'markers',
			'description' => esc_html__( 'You can add multiple markers to the map', 'infinity' ),
			...
			'params'      => array(
				array(
					...
					'param_name'  => 'address',
					'admin_label' => true,
					'description' => wp_kses( __( 'Enter address or coordinate. To learn how to get coordinates, visit <a href="https://support.google.com/maps/answer/18539?hl=en" target="_blank">here</a>', 'infinity' ), array(
						'a' => array(
							'href'   => array(),
							'target' => array(),
						),
