...
function tm_renovation_config() {
	$args = array(
		'styles_priority' => 999,
		'width'           => '300px',
		'url_path'        => THEME_ROOT . '/core/kirki/'
	);
 ...
 */
// default value
require_once TM_RENOVATION_PATH . '/inc/variables.php';
require_once TM_RENOVATION_PATH . '/inc/presets/preset-reader.php';
require_once TM_RENOVATION_PATH . '/inc/customizer/panels.php';

add_filter( 'kirki/values/get_value', 'infinity_kirki_db_get_theme_mod_value', 10, 2 );
function infinity_kirki_db_get_theme_mod_value( $value, $setting ) {
	static $settings;
